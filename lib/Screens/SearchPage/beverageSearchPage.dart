...
class BeverageSearchPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final searchResult = Provider.of<BeverageSearch>(context);
                  ...
                  return Container(
                    ...
                    child: Column(children:<Widget>[
                        ...
                        Row(
                          ...
                          children: <Widget>[
                          Container(margin: EdgeInsets.only(left:8.0) ,child: Text('Rs. '+searchResult.searchData[index]['price'],
