                ...
                child: GridView.builder(
                    ...
                    itemBuilder: (context, int index) {
                      return GestureDetector(
                        onTap: () {
                          cartdata.initPrice(
                              int.parse(beverageData.newList[index]['price']));
                          ...
                          showModalBottomSheet(
                              ...
                              builder: (_) {
                                return BottomSheetModalBeverage(
                                    ...
                                    unit: '',
                                    type: 'hard',
                                    rating: beverageData.newList[index]['rating'],
                                            ...
                                            color: Colors.white))),
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  SizedBox(width:3.0),
                                                  Text(beverageData.newList[index]['rating'], style: TextStyle(fontSize:14.0, fontWeight: FontWeight.w300, color: Colors.white),),
                                                ],
                                              ),
                                SizedBox(height: 8.0),
                                Row(
                                  ...
                                  children: <Widget>[
                                    Text(
                                        ...
                                        style: TextStyle(
                                            ...
                                            fontSize: 16.0)),
                                    Text(
                                        beverageData.newList[index]['amt']+' ml',
                                        style: TextStyle(
                                            color: Colors.white,
                                            fontSize: 16.0))
                                  ],
